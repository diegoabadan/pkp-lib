...
The PKP Web Application Library (PKP-WAL) is a library shared by [Open Journal Systems (OJS)](http://github.com/pkp/ojs), [Open Conference Systems (OCS)](http://github.com/pkp/ocs), [Open Monograph Press (OMP)](http://github.com/pkp/omp), [Open Harvester Systems (OHS)](http://github.com/pkp/harvester) and [(Open Preprint Systems)](https://github.com/pkp/ops/). It is distributed with those applications in the `lib/pkp` subdirectory.
